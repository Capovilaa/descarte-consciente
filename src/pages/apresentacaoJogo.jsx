        ...
        <div className="w-full h-3/5 flex flex-col items-center justify-evenly ">
          ...
          <div className="bg-white w-5/6 h-64 rounded-lg flex items-center justify-center">
            <div className="w-5/6 h-5/6 flex flex-col items-center justify-around">
              <p className="text-[#334333] font-medium pt-4 text-lg">
                Acesse nosso <b>jogo</b> para aplicar seu conhecimento quanto ao{" "}
                <b>descarte</b> consciente.
              </p>
              <p className="text-[#334333] font-medium pt-4 text-lg">
                Itens irão aparecer na tela, sua missão é escolher a lixeira{" "}
                <b>correta</b> para ele.
              </p>
            </div>
          </div>
